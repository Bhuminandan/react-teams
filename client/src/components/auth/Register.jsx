...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const res = await axios.post('https://localhost:9000/register', {
          email,
          password
        })
  ...
  return (
    <div className='w-full h-full flex flex-col items-center justify-center gap-5 bg-gradient-to-r from-slate-900 to-slate-700'>
        ...
        <button className='p-2 border-none bg-slate-200 rounded-lg focus:ring-0 outline-none font-medium uppercase hover:bg-slate-300' type='submit'>Register</button>
        </form>
    </div>
